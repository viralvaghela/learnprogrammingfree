    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          ...
          image: NetworkImage("https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/v311-ning-03-christmaspatterns_2.jpg?bg=transparent&con=3&cs=srgb&dpr=1&fm=jpg&ixlib=php-3.1.0&q=80&usm=15&vib=3&w=1300&s=c2bd81818b67372ded46e12811b15d9c"),
          fit: BoxFit.cover, alignment: AlignmentDirectional.topCenter,
          ),),
          child: Container(
            decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Welcome to",
                          style: TextStyle(color: Colors.black54, fontSize: 18, fontWeight: FontWeight.w500),textAlign: TextAlign.start,),
                        Text(
                          "Learn\nProgramming",
                ...
                Text("Free Courses for you:", style: TextStyle(fontWeight: FontWeight.w700, color: Colors.deepPurpleAccent),),
                Container(
                      ...
                      builder: (context, snapshot) {
                        ...
                        ListView(
                          ...
                          children: snapshot.data.map((item) {
                            return Container(
                                padding: EdgeInsets.only(top: 05, left: 25, right: 25),
                                width: width,
                                child: Card(
                                  elevation: 2,
